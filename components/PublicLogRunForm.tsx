...
export default function PublicLogRunForm({ runners }: { runners: {name: string, email: string}[] }) {
  ...
  return (
    <div className="log-form reveal visible" style={{ marginTop: '24px', background: 'var(--surface)', padding: '32px', borderRadius: '12px', border: '1px solid var(--border)', maxWidth: '800px', margin: '0 auto' }}>
      <h3 style={{ fontSize: '1.4rem', marginBottom: '8px', fontFamily: "'Bebas Neue', sans-serif" }}>Quick Log (No Login Required)</h3>
      <p style={{ opacity: 0.8, marginBottom: '24px', fontSize: '0.9rem' }}>Just select your name and add your distance. (For advanced charts and history, use the Dashboard).</p>
